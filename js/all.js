...
function changeTown(e) {
  // 已選擇 城市 + 已選擇 地區
  var countyAndTownStr = _selectedCounty + e.target.value;
  var pharmacyData = _data.filter(function (element) {
